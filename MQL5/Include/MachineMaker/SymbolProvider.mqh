#ifndef MM_SYMBOLPROVIDER_MQH
#define MM_SYMBOLPROVIDER_MQH

#include "Logger.mqh"
#include "Utils.mqh"

class CMMSymbolProvider
{
private:
...
public:
   ...
   void SetLogger(CMMLogger *log) { m_log = log; }
   ...
   SMMSymbolSpec Spec() const { return m_spec; }
   string SymbolName() const { return m_spec.symbol; }
   double Bid() const { return SymbolInfoDouble(m_spec.symbol, SYMBOL_BID); }
   double Ask() const { return SymbolInfoDouble(m_spec.symbol, SYMBOL_ASK); }
